...
namespace Engine::Graphics {
    ...
    public:
        D3D11SDRCubemapTexture(ID3D11Device& device, char const* env_path, char const* specular_path = nullptr, char const* diffuse_path = nullptr);
    ...
    public:
        D3D11HDRCubemapTexture(ID3D11Device& device, char const* env_path, char const* specular_path, char const* diffuse_path);
