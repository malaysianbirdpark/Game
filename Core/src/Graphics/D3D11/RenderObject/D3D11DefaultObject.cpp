...
Engine::Graphics::D3D11DefaultObject::D3D11DefaultObject(ID3D11Device& device, ID3D11DeviceContext& context, D3D11SceneGraph&& scene)
...
Engine::Graphics::D3D11SceneGraph* Engine::Graphics::D3D11DefaultObject::GetScene() {
    return _scene.get();
}

void Engine::Graphics::D3D11DefaultObject::Render(ID3D11DeviceContext& context) {
...
void Engine::Graphics::D3D11DefaultObject::Update(float const dt) {
    _scene->Update();
}
